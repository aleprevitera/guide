...
study_time: 4 settimaneee
difficulty: '3'
exam_type: Scritto
exam_details: |-
  ```markdown
  Esame scritto, 45 minuti di tempo. Sono presenti 3 **macroargomenti**, in
    genere 2 trattati da Fusar Poli e 1 trattato da Brondino/Berlincioni: 10
    domande VoF per ognuno dei 3 macroargomenti più 2 domande aperte di cui una in
    genere è un caso clinico da discutere brevemente o un criterio DSM-5.
...
program: |-
  ```plain
  	- Disturbi dello spettro della Schizofrenia: aspetti storici e psicopatologici; aspetti clinici, epidemiologici, sociali ed evolutivi; eziologia, aspetti biologici, terapia e cura.
